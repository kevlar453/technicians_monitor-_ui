                                ...
                                <tbody>
                                    ...
                                    foreach ($user as $isi) { ?>
                                      <?php if ($this->session->userdata('level') != 'technician' && $this->session->userdata('level') != 'operator') { ?>
                                        <?php if ($this->session->userdata('level') == 'administrator' && $isi['level'] != 'manajemen') { ?>
                                        <tr>
                                            <td><?= $no; ?></td>
                                            <td>
                                                <center>
                                                    <?php if (!empty($isi['foto'] !== "-")) { ?>
                                                        <img src="<?php echo 'data:image/png;base64,' . $isi['foto']; ?>" alt="#" class="img-responsive" style="height:auto;width:100px;" />
                                                    <?php } else { ?>
                                            ...
                                            <td><?= $isi['nama']; ?></td>
                                            <td><?= $isi['user']; ?></td>
                                            <td><?= $isi['clidentitas']; ?></td>
                                            <td><?= $isi['jenkel']; ?></td>
                                            <td><?= $isi['telepon']; ?></td>
                                            <td><?= $isi['level']; ?></td>
                                            <?php if ($isi['level'] == 'technician') { ?>
                                            ...
                                            <tr>
                                                ...
                                                <?php }
                                                $no++;
                                              } elseif ($this->session->userdata('level') == 'master') { ?>
                                              <tr>
                                                  <td><?= $no; ?></td>
                                                  <td>
                                                      <center>
